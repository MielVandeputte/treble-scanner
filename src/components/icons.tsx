...
export const FilledInBoltIcon = forwardRef<SVGSVGElement, Readonly<SVGAttributes<SVGSVGElement>>>(
  ({ className, ...props }, ref) => (
    <svg
      {...props}
      ref={ref}
...
export const ArrowPathIcon = forwardRef<SVGSVGElement, Readonly<SVGAttributes<SVGSVGElement>>>(
  ({ className, ...props }, ref) => (
    <svg
      {...props}
      ref={ref}
...
export const WifiIcon = forwardRef<SVGSVGElement, Readonly<SVGAttributes<SVGSVGElement>>>(
  ({ className, ...props }, ref) => (
    <svg
      {...props}
      ref={ref}
