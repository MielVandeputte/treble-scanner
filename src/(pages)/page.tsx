...
export function Login() {
    ...
    return (
        <form
            ...
            className="flex flex-col justify-center items-center w-screen h-dvh gap-5 p-5 px-10 select-none"
        >
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                {errorMessageState && (
                    <span className="font-semibold text-rose-800 text-center">{errorMessageState}</span>
                )}
            </div>
        </form>
    );
